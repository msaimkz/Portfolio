...
function Project() {
    const projects = [

        {
            ...
            short_description: "Ephemeral Equilibrium is an animated static website built using Shery.js",
            description: "Ephemeral Equilibrium is a visually captivating animated static website crafted with the Shery.js library. It features dynamic motion effects, smooth transitions, and engaging visual storytelling to enhance user interaction. ",
        ...
        },
        {
            ...
            short_description: "Harvel Electric is an animated e-commerce static website for an electric shop",
            description: "Harvel Electric is a dynamic and engaging e-commerce website designed for an electric shop. Developed using HTML, CSS, and JavaScript, it features smooth animations for an interactive user experience. The site utilizes JSON to implement a category filter, allowing users to browse products efficiently. Additionally, a product detail modal enhances the shopping experience by displaying key product information in a user-friendly manner.",
    ...
    document.querySelectorAll(".projectName").forEach((item) => item.textContent = project.title)
    document.querySelector(".image-container>img").setAttribute("src", project.img)
